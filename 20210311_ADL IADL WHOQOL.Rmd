...
# Baseline Data 
    bsln_data <- read_csv(here::here("Data", "Archived data versions", "20210305_OSEAR Baseline Data.csv"))
    bsln_codebook <- read_csv(here::here("Data", "Archived data versions", "20210306_OSEAR Baseline Codebook.csv"))
    colnames(bsln_data) <- colnames(bsln_codebook)

# 6 month data 
    fup_data <- read_csv(here::here("Data", "Archived data versions", "20210311_APICS01 OSEAR 6mo Data.csv"))
    fup_codebook <- read_csv(here::here("Data", "20210402_APICS01 OSEAR 6mo Codebook.csv"))
