...
sat_ans <- c("Very satisfied", "Satisfied", "Neither satisfied nor dissatisfied", "Dissatisfied", "Very dissatisfied", "Missing", "other") 
...
sat_tab2 <- apply(sat_data, 2, sat_func) %>% 
  t() %>% 
  as.data.frame()
